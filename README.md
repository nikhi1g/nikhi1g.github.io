...
- `/seminal_papers/` — [seminal_papers/index.html](seminal_papers/index.html), a searchable archive of notable papers, essays, memos, and more, with a GitHub-issue-based submission flow (`.github/workflows/`)
